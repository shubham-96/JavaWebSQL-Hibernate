...
<div align="center">
	<div align="left" class="w3-blue" style="position:fixed; width:100%; z-index:5; padding-left:16px; padding-top:8px">
		<h1>Register</h1>
		<div class="w3-bar">
		<a class="w3-button w3-blue w3-hover-light-grey" href="index.jsp">Home</a>
		<a class="w3-button w3-blue w3-disabled">List</a>
		</div>
	</div>

	<div class="w3-container" style="width:70%; position:relative; top:150px">
		<div align="left" class="w3-card w3-white w3-leftbar w3-border-blue">
			<a><noscript>javascript is disabled!</noscript></a>
			<form action="EmployeeServlet" method="post"><br />
			<table id="showlist">
				<tr>
					<th><p>Company Employee ID : </p></th>
					<td colspan="2"><input id="CompanyEmployeeID" class="w3-input w3-light-grey w3-border-0" type="text" name="comEmpID"></td>
				...
				<tr>
					<th><p>Name : </p></th>
					<td colspan="3"><input id="username" class="w3-input w3-light-grey w3-border-0" type="text" name="username"></td>
				</tr>
				<tr>
					<th><p>Department: </p></th>
					<td colspan="3"><select required class="w3-select w3-light-grey w3-border-0" name="department">
				...
				<tr>
					...
					<td colspan="3"><input class="w3-input w3-light-grey w3-border-0" list="travelmode_arrival" name="travelmode_arrival">
				...
				<tr>
					...
					<td colspan="3"><input class="w3-input w3-light-grey w3-border-0" list="travelmode_departure" name="travelmode_departure">
				...
				<tr>
					...
					<td colspan="3"><input id="contact" class="w3-input w3-light-grey w3-border-0" type="text" name="contact"></td>
				</tr>
				<!-- <tr>
